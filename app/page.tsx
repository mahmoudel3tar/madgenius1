      ...
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-3 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          <h1 className="max-w-xs text-3xl font-semibold leading-10 tracking-tight text-black dark:text-zinc-50">
            Expert Technical Consultations for Every Field in Technology.
          </h1>
          <p className="max-w-md text-lg leading-8 text-zinc-600 dark:text-zinc-400">
Leave the burden of Technical work to us and let our specialized team manage every aspect of Technology with high efficiency, freeing you to focus on cirtical decision and fruitful achievements            <a
...
We Know Technology Well <br/> Our staff is a blend of fine young men and woman who share a common passion for Technology. they are happy to help at any time and answer your questions. <a
      ...
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-3 px-3 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          <h1 className="max-w-xs text-3xl font-semibold leading-10 tracking-tight text-black dark:text-zinc-50">
Everything is possible within your hands</h1>
          <p className="max-w-md text-lg leading-8 text-zinc-600 dark:text-zinc-400">
Begin your journey towards success; everything is possible with determination and willpower. Let us be your partner in achieving success.
. <a
              href="https://vercel.com/templates?framework=next.js&utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app"
              className="font-medium text-zinc-950 dark:text-zinc-50"
            >
